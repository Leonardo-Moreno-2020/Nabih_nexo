...
<div class="container-fluid bg-secondary">
        <div class="row">
            <div class="col-md">
                <header class="py-3">
                    <h3 class="text-center text-light bg-5">Técnicos registro y seguimiento</h3>
                </header>
            </div>
        </div>
    </div>
...
<?php
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Registrado !</strong> Se agrego un Técnico.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
    <?php
            }
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>Técnico-eliminado !</strong> Los registros fueron eliminados.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
    <?php
            }
...
<a class="btn btn-danger" href="../reportes/reporte_tecnico.php" role="button">Reporte PDF</a>
                            ...
                            <?php   
                              ...
                              <tr> 
                               <td scope="row"><?php echo $dato->Id;?></td>
                                ...
                                <td class="text-center"><?php echo $dato->Local;?></td>
